...
import './Teacher1Details.css';
import { FaGithub, FaFacebook, FaInstagram, FaLinkedin } from "react-icons/fa"
import { Link } from 'react-router-dom';



const Teacher1Details = () => {
    return (
        <div className='container mt-4'>
            <div className="card w-75 mx-auto">
                <img src={teacher1} className="card-img-top img-fluid" alt="..." />
                <div className="card-body">
                    <h2 className="card-title">Fahim Faysal</h2>
                    <h5 className="card-text">React Instructor</h5>
                    <h6 className='text-muted'>BSc: American International University Bangladesh (AIUB)</h6>
                    <h6 className='text-muted'>MSc: American International University Bangladesh (AIUB)</h6>
                    <h6 className='text-muted'>Email: fahimfaysal@gmail.com</h6>
                    <h6 className='text-muted'>Mobile: 0123456789</h6>
...
export default Teacher1Details;